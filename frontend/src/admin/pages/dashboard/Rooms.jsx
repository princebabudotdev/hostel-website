    ...
    <div className="bg-[#f4f6f9] min-h-screen">
      ...
      <div className="mt-5  px-4 ">
        <NavLink
          ...
          className="bg-black  text-white flex items-center justify-center gap-2 py-3 rounded-md text-sm font-medium"
        >
          <Plus size={16} />
          Create New Room
        </NavLink>
      ...
      <div className="max-w-3xl mx-auto py-4 px-1 space-y-4">
        ...
        {editingRoom && (
          <div className="bg-white p-4 shadow-sm space-y-3">
            <h2 className="text-sm font-semibold">Edit {editingRoom.type}</h2>
    ...
    <div className="bg-white p-4 space-y-3 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-gray-500">₹{room.priceYear}/year</p>
        </div>
      </div>
